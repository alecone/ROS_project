...
if("TRUE" STREQUAL "TRUE")
  set(mrpt_graphslam_2d_SOURCE_PREFIX /home/alecone/catkin_graph/src/mrpt_slam/mrpt_graphslam_2d)
  set(mrpt_graphslam_2d_DEVEL_PREFIX /home/alecone/catkin_graph/devel)
  ...
  set(mrpt_graphslam_2d_INSTALL_PREFIX /home/alecone/catkin_graph/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrpt_graphslam_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alecone/catkin_graph/src/mrpt_slam/mrpt_graphslam_2d/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;std_msgs;sensor_msgs;geometry_msgs;nav_msgs;mrpt_bridge;mrpt_msgs;tf;multimaster_msgs_fkie")
